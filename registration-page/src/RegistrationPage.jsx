    ...
    return(<div className="LoginPage">
        <nav>
         ...
         <div className='container'>
            <div className="head">
            <h1>Register Now</h1>
            <p>Hi Dear, Want to start you new learning journey, wants to learn most <br/> demanding technologies and achieve your dream career, Join <b>TechSimPlus family</b> now.</p>
            </div>
           <div className="login-form">
                <div className='Regist-data'>
                  <div><label>Full Name</label><br/>
                    <input onChange={onInputValueChange} placeholder='Enter Your Name' type="text" />
                  </div>
                ...
                <div className='Pass'>
                    ...
                    <p>You can use this password to login your account.</p>
                    <p>We will send you Verification code on your email address.</p>
                </div>
                <div className="btn-parent"><button className='button-login'>Next</button></div>
